...
| [04-match-lifecycle.md](04-match-lifecycle.md) | F4 | Tempo de partida, frag limit, fim de match, ENTER restart |
| [05-multi-room.md](05-multi-room.md) | F5 | Salas concorrentes, token allowlist, cliente espectador |
